...
<template>
  <section class="d-flex  mx-auto">
    ...
    <div id="infoCard" v-if="country" class=" d-flex flex-column ">
      <BCard class="d-flex mx-auto" style=" background-color: rgb(244, 237, 215);">
        <div class="d-flex justify-content-between">
          <h1> {{ country.translations.swe.common }}</h1> <router-link to="/countries" class=" d-flex align-items-start">
        ...
        <BCardText>
          ...
          <h2>Kartor</h2>
          <ul>
            <li>Google Maps: <a :href="country.maps.googleMaps" target="_blank">Link</a></li>
            <li>OpenStreetMaps: <a :href="country.maps.openStreetMaps" target="_blank">Link</a></li>
          </ul>
        </BCardText>
